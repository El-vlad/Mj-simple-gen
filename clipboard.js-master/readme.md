...
using [GitHub's Primer](https://primer.style/css/components/tooltips). You may want to check that out if you're looking
...
is [supported by all browsers](https://caniuse.com/#search=selection) while the second one is supported in the following
browsers.
...
A browser extension that adds a "copy to clipboard" button to every code block on _GitHub, MDN, Gist, StackOverflow,
StackExchange, npm, and even Medium._
